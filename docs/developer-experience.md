...
This guide covers the optimized developer experience for the Nanna Coder
project, including development utilities, workflows, and best practices.
...
When entering the development shell with `nix develop`, the following is
...
For additional help or feature requests, consult the project documentation or
