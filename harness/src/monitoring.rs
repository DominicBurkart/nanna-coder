...
mod tests {
    ...
    #[tokio::test]
    async fn test_send_alert_all_severity_variants() {
        let manager = DefaultAlertManager::new();
        manager
            .send_alert("Info", "msg", AlertSeverity::Info)
            .await
            .unwrap();
        manager
            .send_alert("Warning", "msg", AlertSeverity::Warning)
            .await
            .unwrap();
        manager
            .send_alert("Error", "msg", AlertSeverity::Error)
            .await
            .unwrap();
        manager
            .send_alert("Critical", "msg", AlertSeverity::Critical)
            .await
            .unwrap();
