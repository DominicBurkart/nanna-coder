...
mod tests {
    ...
    #[test]
    fn test_parse_github_remote_ssh_missing_repo() {
        let result = parse_github_remote("git@github.com:owner/");
        assert_eq!(result, None);
    }

    #[test]
    fn test_parse_github_remote_ssh_missing_owner() {
        let result = parse_github_remote("git@github.com:/repo");
        assert_eq!(result, None);
    }
}
