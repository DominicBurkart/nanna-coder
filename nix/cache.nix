...
let
  ...
  binaryCacheUtils = {
    ...
    setup-cache = pkgs.writeShellApplication {
      name = "setup-cache";
    ...
    push-cache = pkgs.writeShellApplication {
      name = "push-cache";
      runtimeInputs = [ pkgs.cachix pkgs.nix ];
      text = ''
    ...
    ci-cache-optimize = pkgs.writeShellApplication {
    ...
    cache-analytics = pkgs.writeShellApplication {
      name = "cache-analytics";
      runtimeInputs = [ pkgs.cachix pkgs.nix pkgs.coreutils pkgs.gnugrep ];
      text = ''
